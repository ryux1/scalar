...
The handler package declares Next.js 15 and 16, React 19, and Node.js 22 or newer. See the installed package's peer dependencies for its supported versions.
